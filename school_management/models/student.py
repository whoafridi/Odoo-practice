...
class Student(models.Model):
    ...
    semester = fields.Selection(
        [('04', 'Summer'), ('05', 'Fall'), ('06', 'Spring')], string="Semester")
    roll = fields.Char(string='Your roll')
    department = fields.Selection([('01', 'CSE'), ('02', 'BBA'), ('03', 'EEE'), (
        '04', 'CE'), ('05', 'ICT'), ('06', 'ICE'), ('07', 'CoE')], string='Department')
    std_id = fields.Char(string='ID No.')
    generated_email = fields.Char(string="Generated email")
    email_domain = fields.Selection(
        [('yahoo', 'yahoo'), ('gmail', 'gmail'), ('diu', 'diu.edu.bd')], string="Email domain")
    ...
    @api.onchange('email_domain')
    def generate_email(self):
        if self.email_domain:
            if self.email_domain == 'yahoo':
                email = self.first_name.lower() + '-' + self.std_id + '@yahoo.com'
                self.generated_email = email
            elif self.email_domain == 'gmail':
                email = self.first_name.lower() + '-' + self.std_id + '@gmail.com'
                self.generated_email = email
            elif self.email_domain == 'diu':
                email = self.first_name.lower() + '-' + self.std_id + '@diu.edu.bd'
                self.generated_email = email
